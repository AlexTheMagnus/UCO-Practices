...
class tensionSistolica(Parametro):
    ...
    '''
    def __init__(self):
        Parametro.__init__(self, nombre=u'Tension Sistolica', unidad='mmHg')
...
class tensionDiastolica(Parametro):
    ...
    '''
    def __init__(self):
        Parametro.__init__(self, nombre=u'Tension Diastolica', unidad='mmHg')
...
class frecuenciaCardiaca(Parametro):
    ...
    '''
    def __init__(self):
        Parametro.__init__(self, nombre=u'Frecuencia Cardiaca', unidad='puls/min')
...
class nivelOxigeno(Parametro):
    ...
    '''
    def __init__(self):
        Parametro.__init__(self, nombre=u'Nivel de Oxigeno', unidad='%')
