...
#Obtener las gemas y durezas de las gemas con dureza mayor o igual que 7.5 ordenadas de mayor a menor
def q4():
    ...
    query='''  
        ...
        WHERE { ?x prop:name ?name .
                ?x prop:hardness ?hardness .
                FILTER (?hardness >= 7.5) }
        ORDER BY DESC(?hardness)
    ''' 

    result = g.query(query)
    print '4. Obtener las gemas y durezas de las gemas con dureza mayor o igual a 7.5 ordenadas de mayor a menor:'
    print '======================================================================================================'
    ...
    for row in result:
        #print row
        print "La dureza de %s es %s" % tuple(row)
    print
